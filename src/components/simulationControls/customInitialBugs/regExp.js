...
export const colorListRegExp = new RegExp(
  /^\s*(\[(([0-9]|[0-9][0-9]|[0-1][0-9][0-9]|[0-2][0-5][0-5]),){2}([0-9]|[0-9][0-9]|[0-1][0-9][0-9]|[0-2][0-5][0-5])\]c?\s*,\s*){0,}\[(([0-9]|[0-9][0-9]|[0-1][0-9][0-9]|[0-2][0-5][0-5]),){2}([0-9]|[0-9][0-9]|[0-1][0-9][0-9]|[0-2][0-5][0-5])\]c?\s*,*\s*$/,
  "g"
);
